...
private:
  ...
  const static int pwm_pin_clock = 22; //P99
  const static int pwm_pin_sync = 17;  //FPGA - P105
  const static int pwm_pin_dataX = 19;  //FPGA - P103
  const static int pwm_pin_dataY = 14;  //P111
};
